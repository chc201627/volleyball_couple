...
(function () {
  ...
  var translations = {
    en: {
      ...
      'tournament.search.label': 'Search matches by player or team',
      'tournament.search.placeholder': 'Search team or player…',
      'tournament.search.clear': 'Clear search',
      'tournament.search.resultsCount': 'Found {count} matches',
      'tournament.search.noResults': 'No matches found for "{query}"',
      'tournament.scoreboard.heading': 'Match Score',
      'tournament.scoreboard.team': 'Team',
      'tournament.scoreboard.back': '‹ Back to matches',
      'tournament.scoreboard.denied': '⛔ No scoring permission',
      'tournament.scoreboard.discard': 'Discard',
      'tournament.scoreboard.finishConfirm': 'Finish {score1}–{score2}?',
      'tournament.scoreboard.confirm': 'Confirm',
      'tournament.scoreboard.keepScoring': 'Keep scoring',
      'tournament.scoreboard.conflictLocal': '⛔ Conflict — your {score1}–{score2} was not saved',
      'tournament.scoreboard.conflictServer': 'Server has {score1}–{score2} (confirmed)',
      ...
      'tournament.sync.revoked': '👁 Access revoked',
      ...
      'workspace.tournament.nextMatch.heading': 'Next match',
      ...
      'workspace.tournament.nextMatch.resumeBtn': 'Resume scoring',
      'workspace.tournament.nextMatch.seeResults': 'See results',
      'workspace.tournament.stageProgress.heading': 'Stage progress',
      'workspace.tournament.stageProgress.count': '{played}/{total} played',
      'workspace.tournament.stageProgress.notStarted': 'Not started',
      'tournament.day.stageProgress.group': 'Group {group}',
      'workspace.tournament.section.live': 'Live ({count})',
      'workspace.tournament.section.pending': 'Up next ({count})',
      'workspace.tournament.section.recentlyFinished': 'Recently finished ({count})',
      'workspace.tournament.showAll': 'Show all ({count})',
      'workspace.tournament.matchRow.score': 'Score',
      'workspace.tournament.matchRow.resume': 'Resume',
      'workspace.tournament.notFound.heading': 'Session unavailable',
      'workspace.tournament.notFound.text': 'This link is missing, expired, or you do not have permission to read it. Ask the organizer for a new link.',
      ...
      'workspace.results.groupWinners.heading': 'Group winners',
      'workspace.results.groupWinners.tied': '(tied)',
      'workspace.results.tiedLead.heading': 'Tied lead',
      'workspace.results.summary.matches': '{played}/{total} matches played',
      'workspace.results.summary.rallies': '{count} rallies played',
      'workspace.results.bracket': 'Bracket',
      'workspace.results.export': 'Copy / share summary',
      'workspace.results.export.copied': '✓ Copied!',
      'workspace.results.export.shared': '✓ Shared!',
      'workspace.results.export.title': 'Tournament summary',
      'workspace.results.export.championLine': 'Champion: {team}',
      'workspace.results.export.groupWinnerLine': '{group} winner: {team}',
      'workspace.results.export.tiedLeadLine': 'Tied lead: {teams}',
      'workspace.results.export.noChampion': 'No champion yet',
      'workspace.results.startAnother': 'Start another tournament',
      // Footer

      'footer.copyright': '\u00a9 2026 Beach Volleyball Couple Matching \u2014 v1.9.2'
    ...
    es: {
      ...
      'tournament.search.label': 'Buscar partidos por jugador o dupla',
      'tournament.search.placeholder': 'Buscar dupla o jugador…',
      'tournament.search.clear': 'Limpiar búsqueda',
      'tournament.search.resultsCount': '{count} partidos encontrados',
      'tournament.search.noResults': 'No se encontraron partidos para "{query}"',
      'tournament.scoreboard.heading': 'Resultado Partido',
      'tournament.scoreboard.team': 'Equipo',
      'tournament.scoreboard.back': '‹ Volver a los partidos',
      'tournament.scoreboard.denied': '⛔ Sin permiso para anotar',
      'tournament.scoreboard.discard': 'Descartar',
      'tournament.scoreboard.finishConfirm': '¿Finalizar {score1}–{score2}?',
      'tournament.scoreboard.confirm': 'Confirmar',
      'tournament.scoreboard.keepScoring': 'Seguir anotando',
      'tournament.scoreboard.conflictLocal': '⛔ Conflicto — tu {score1}–{score2} no se guardó',
      'tournament.scoreboard.conflictServer': 'El servidor tiene {score1}–{score2} (confirmado)',
      ...
      'tournament.sync.revoked': '👁 Acceso revocado',
      ...
      'workspace.tournament.nextMatch.heading': 'Pr\u00f3ximo partido',
      ...
      'workspace.tournament.nextMatch.resumeBtn': 'Continuar anotando',
      'workspace.tournament.nextMatch.seeResults': 'Ver resultados',
      'workspace.tournament.stageProgress.heading': 'Progreso de la etapa',
      'workspace.tournament.stageProgress.count': '{played}/{total} jugados',
      'workspace.tournament.stageProgress.notStarted': 'Sin comenzar',
      'tournament.day.stageProgress.group': 'Grupo {group}',
      'workspace.tournament.section.live': 'En vivo ({count})',
      'workspace.tournament.section.pending': 'Siguientes ({count})',
      'workspace.tournament.section.recentlyFinished': 'Finalizados recientemente ({count})',
      'workspace.tournament.showAll': 'Ver todos ({count})',
      'workspace.tournament.matchRow.score': 'Anotar',
      'workspace.tournament.matchRow.resume': 'Continuar',
      'workspace.tournament.notFound.heading': 'Sesi\u00f3n no disponible',
      'workspace.tournament.notFound.text': 'Este enlace falta, expir\u00f3, o no tienes permiso para leerlo. Pide al organizador un enlace nuevo.',
      ...
      'workspace.results.groupWinners.heading': 'Ganadores de grupo',
      'workspace.results.groupWinners.tied': '(empatado)',
      'workspace.results.tiedLead.heading': 'Empate en el liderato',
      'workspace.results.summary.matches': '{played}/{total} partidos jugados',
      'workspace.results.summary.rallies': '{count} rallies jugados',
      'workspace.results.bracket': 'Cuadro',
      'workspace.results.export': 'Copiar / compartir resumen',
      'workspace.results.export.copied': '\u2713 \u00a1Copiado!',
      'workspace.results.export.shared': '\u2713 \u00a1Compartido!',
      'workspace.results.export.title': 'Resumen del torneo',
      'workspace.results.export.championLine': 'Campe\u00f3n: {team}',
      'workspace.results.export.groupWinnerLine': 'Ganador de {group}: {team}',
      'workspace.results.export.tiedLeadLine': 'Empate en el liderato: {teams}',
      'workspace.results.export.noChampion': 'A\u00fan sin campe\u00f3n',
      'workspace.results.startAnother': 'Iniciar otro torneo',
      // Pie de p\u00e1gina

      'footer.copyright': '\u00a9 2026 Emparejamiento de V\u00f3ley Playa \u2014 v1.9.2'
