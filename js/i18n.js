...
(function () {
  ...
  var translations = {
    en: {
      ...
      'footer.copyright': '\u00a9 2026 Beach Volleyball Couple Matching \u2014 v2.0.0',
      ...
      'import.issue.invalidLevel': '"{token}" is not a level (1, 2 or 3)',
    ...
    es: {
      ...
      'footer.copyright': '\u00a9 2026 Emparejamiento de V\u00f3ley Playa \u2014 v2.0.0',
      ...
      'import.issue.invalidLevel': '«{token}» no es un nivel (1, 2 o 3)',
